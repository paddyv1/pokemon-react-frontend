...
export default function SignupPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <div className="overflow-hidden rounded-2xl border-2 border-slate-900 bg-linear-to-br from-amber-100 via-emerald-50 to-sky-100 shadow-[10px_10px_0px_0px_rgba(15,23,42,1)]">
          ...
          <section className="bg-white p-6">
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full rounded-lg border-2 border-slate-900 bg-slate-900 px-4 py-2 font-semibold text-white transition hover:translate-y-px hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
